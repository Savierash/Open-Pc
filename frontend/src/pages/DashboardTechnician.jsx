...
const DashboardTechnician = () => {
  ...
  const { user, accessToken, loading: authLoading } = useAuth(); // ✅ get from context
  ...
  // ✅ Auto-load dashboard data after user & token available
  useEffect(() => {
  ...
  async function fetchDashboard() {
    try {
      ...
      setData({
        ...
        counts: backendData.counts || { functional: 0, maintenance: 0, outOfOrder: 0 },
  ...
  return (
    <div className="dashboard">
      ...
      <header className="top-bar-dashboard">
        ...
        {/* ✅ Dynamic name and role using AuthContext */}
        ...
        <aside className="sidebar">
          <ul className="sidebar-menu">
            ...
            <li>
              ...
              >
                <img src={ClipboardX} className="menu-icon" alt="Reports Icon" />
                <span>Reports</span>
              </a>
            </li>
            <li>
